...
def getCategoryCode(title_name):
	if "ニュース" in title_name:
		...
		return "101103"
	elif "Bリーグ" in title_name or "B2リーグ" in title_name or "Vリーグ" in title_name or "Wリーグ" in title_name or "熱血バスケ" in title_name or "バスケットボール" in title_name or "ラグビー" in title_name or "テニス" in title_name or "ウィンブルドン" in title_name or "ハンドボール" in title_name  or "バレーボール" in title_name  or "甲子園ボウル" in title_name or "Nitto" in title_name:
		return "101104"
	elif  "相撲" in title_name or "剣道" in title_name or "柔道" in title_name or "空手道" in title_name:
		return "101105"
	elif "競泳" in title_name or "陸上選手" in title_name:
		return "101107"
